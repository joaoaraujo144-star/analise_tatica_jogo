 ...
 *   1.3 (2026-09-17) — botão "Gerar análise" fica escondido numa equipa de
 *                       teste (trial_teams) — a Edge Function gerar-insights
 *                       também recusa o pedido, isto só evita mostrar um botão
 *                       que ia falhar.
 *   1.4 (2026-09-17) — "Sair" numa equipa de teste leva a trial.html em vez de
 *                       login.html (reaproveita a mesma verificação de
 *                       trial_teams feita para o botão "Gerar análise").
 *   1.5 (2026-09-17) — corrige "Sair" numa equipa de teste: deixa de chamar
